---
title: "Historic Masonry Restoration in River Forest, IL — Sensitive Brick Repair for Prairie-Era Estates and Institutional Buildings"
date: "2026-05-20"
primaryKeyword: "historic masonry restoration River Forest IL"
secondaryKeywords:
  - historic brick repair River Forest IL
  - masonry contractor River Forest Illinois
  - lime mortar repointing River Forest IL
  - Prairie-era brick restoration Cook County
  - historic building masonry River Forest
  - tuckpointing River Forest IL
  - brick restoration west suburban Chicago
  - masonry restoration River Forest IL
...
- **Soft original brick** — Prairie-era brick in the Chicago area was typically less vitrified and softer than postwar brick. It's more susceptible to damage from hard modern mortar and requires careful handling during joint cutting.
- **Original lime mortar** — Pre-1930s construction almost universally used true lime mortar, not the lime-Portland hybrid common from the 1940s forward. Lime mortar is softer, more flexible, and vapor-permeable. Repointing with hard modern mortar over a lime-mortar building causes spalling damage within years.
- **Character-defining features** — soldier courses, corbeled brickwork, ornamental brick details, arched openings, and period decorative work that define the building's architectural character require work methods that protect rather than disturb these elements.
- **Institutional scale** — The academic and institutional buildings on Dominican University's campus represent full-scope masonry assessments and multi-phase project management at a scale that requires systematic planning.
...
- **Multi-building condition assessment** with written reports prioritizing work by urgency across buildings
- **Phased pricing** for multi-year maintenance budget planning
- **Documentation** that meets institutional facilities management standards for capital planning
- **Scheduling** that accommodates academic and operational calendars
...
For historic masonry restoration, [tuckpointing](/services/tuckpointing), or a full [masonry restoration](/services/masonry-restoration) evaluation in River Forest, contact us to schedule.

[Schedule your historic masonry evaluation today. /#contact](#contact)
