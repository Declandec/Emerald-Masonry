---
title: "Lintel Repair in Crete, IL — Stop Rusted Lintels Before the Brick Comes Down"
date: "2026-06-29"
primaryKeyword: "lintel repair Crete IL"
secondaryKeywords:
  - "lintel replacement crete il"
  - "steel lintel repair will county"
  - "rusted lintel repair crete"
  - "window lintel masonry repair crete il"
  - "brick lintel replacement south suburbs"
  - "sagging brick over window crete il"
  - "rust stain below window repair crete"
  - "door lintel repair crete illinois"
  - "galvanized steel lintel replacement crete"
  - "lintel contractor near crete il"
city: "Crete, IL"
...
faqs:
  - q: "Who repairs rusted lintels in Crete, IL?"
    a: "Emerald Masonry LLC repairs and replaces rusted and failing lintels for homes and commercial buildings in Crete, IL. We remove the brick above the opening, install a new galvanized or painted steel lintel, and reset matched brick. Call (708) 288-1696 for a free on-site estimate."
  - q: "What are the signs my lintel needs repair?"
    a: "The most common signs are orange rust stains running below a window or door, stair-step cracks climbing from the upper corners of an opening, and brick that sags or bows over the window. Gaps opening up between the lintel and the brick are another red flag. Any of these means the steel is rusting and expanding."
  - q: "How much does lintel repair cost in Crete?"
    a: "Cost depends on how many openings are affected, lintel length, whether brick needs to be matched, and access height. We never quote sight-unseen because every opening is different. We provide a free on-site estimate with a clear price before any work begins."
...
1. **Free on-site inspection.** We look at every affected opening, check how far the rust and cracking have traveled, and confirm whether brick can be salvaged and reset or needs to be matched.
2. **Clear written estimate.** You get a defined scope and price before we start — no surprises mid-job.
3. **Protect and remove.** We protect the area, remove the brick above the opening, and take out the failed steel lintel.
4. **Install new steel.** We set a new galvanized or painted steel lintel with correct length and end bearing, plus flashing where the detail calls for it.
5. **Reset and match.** We rebuild the brick with matched brick and color-matched mortar so the repair blends into the wall.
6. **Clean up.** We leave the site clean and walk the finished work with you.
...
- [Lintel repair](/services/lintel-repair) — full steel lintel repair and replacement.
- [Limestone & sill repair](/services/limestone-sill-repair) — for the stone sills below the same windows, which often weather alongside the lintel.
- [Brick repair](/services/brick-repair) — to fix the cracked and displaced brick around the opening.
...
**Call (708) 288-1696** or [request your free estimate](/#contact) today.
