---
title: "Lintel Replacement in Hinsdale, IL — Stopping Rust-Driven Brick Damage Before It Spreads"
date: "2026-04-24"
primaryKeyword: "lintel replacement Hinsdale IL"
secondaryKeywords:
  - steel lintel replacement Hinsdale IL
  - corroded lintel repair Hinsdale
  - brick damage above windows Hinsdale IL
  - masonry lintel contractor DuPage County
  - lintel replacement cost Hinsdale
  - brick repair above door Hinsdale IL
  - rusted lintel masonry damage Illinois
  - lintel replacement near Hinsdale
  - DuPage County lintel masonry contractor
  - brick window arch repair Hinsdale IL
city: "Hinsdale, IL"
...
- **Horizontal cracks along mortar joints** directly above windows or doors, running parallel to the lintel
- **Stepped diagonal cracks** at the corners of window openings, following the mortar joints
- **Brick displacement or bowing** above the opening — the affected courses push out slightly from the wall plane
- **Rust staining** bleeding through the mortar joints or the brick face in the lintel zone
- **Spalling** of the brick faces adjacent to the lintel, where expansion pressure causes the fired face to delaminate
...
- The lintel has expanded and caused cracking or displacement in the surrounding masonry
- Rust staining indicates active, through-section corrosion
- The brick above the opening has shifted from its original plane
- Water has been entering the wall in the lintel zone
- The building is more than 60 years old and lintels have never been replaced
...
- **Experience with historic masonry.** A contractor should know mortar compatibility, brick matching, and proper shoring technique. This isn't general construction work.
- **Flashing and weep system installation.** Ask specifically whether the quote includes new flashing above the lintel zone. If the answer is unclear, the flashing is probably not included.
- **Brick matching.** Hinsdale's older brick has specific colors and textures — replacement material should be sourced to match. A contractor who doesn't mention this isn't planning for it.
- **References from similar projects.** Lintel replacement on residential or commercial brick in Hinsdale's vintage housing stock is a specific credential. Ask for references.
- **Scope in writing.** The quote should specify the number of lintels, the number of courses to be removed and rebuilt, whether flashing is included, and what happens to adjacent mortar joints.

## FAQ: Lintel Replacement in Hinsdale

**How do I know if my lintel needs replacement or just repair?**
If there are horizontal cracks above windows, stepped diagonal cracks at window corners, or any visible displacement of the brick above the opening, the lintel has already expanded enough to require replacement. Surface rust alone (without cracking) may be treatable without full replacement — an on-site inspection will determine which situation you're dealing with.
...
Yes. Brick matching is part of the scope for any lintel replacement on a building where the original facade appearance is important. In Hinsdale, where property values and historical character both matter, we source replacement brick to match the existing color, texture, and format as closely as possible.

**Can I wait on a lintel replacement if the cracking looks minor?**
Lintel failure is progressive, not stable. Once the corrosion-expansion cycle begins, water enters through the cracks, accelerates further corrosion, and the expansion continues. "Minor" cracking above a window becomes structural displacement within a few seasons if not addressed. The repair is less expensive and less disruptive earlier in the process than after significant brick displacement has occurred.

**What's the $5,000 project minimum?**
Emerald Masonry maintains a $5,000 project minimum. Single-lintel replacements on smaller residential openings can fall at or just above this threshold. Multiple lintels or the combination of lintel replacement with tuckpointing of adjacent affected joints typically well exceeds the minimum.
...
See also: [Brick Repair](/services/brick-repair) | [Masonry Restoration](/services/masonry-restoration) | [Tuckpointing](/services/tuckpointing)
