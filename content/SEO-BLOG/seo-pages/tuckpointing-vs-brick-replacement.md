---
title: "Tuckpointing vs. Brick Replacement: Which Does Your Wall Actually Need?"
date: "2026-06-18"
primaryKeyword: "tuckpointing vs brick replacement"
secondaryKeywords:
  - tuckpointing or brick replacement
  - when to tuckpoint vs replace brick
  - repointing vs brick replacement
  - spalling brick repair Chicagoland
  - hollow brick replacement Illinois
  - failed mortar joints repair
  - brick wall repair Chicago suburbs
  - cost of tuckpointing vs brick replacement
  - how to tell if brick needs replacing
  - masonry repair Palos Heights IL
city: "Chicagoland, IL"
service: "Tuckpointing vs Brick Replacement"
serviceSlug: "tuckpointing"
pageType: "comparison"
metaTitle: "Tuckpointing vs Brick Replacement | Emerald Masonry LLC"
...
faqs:
  - q: "Is tuckpointing cheaper than replacing brick?"
    a: "Generally yes, because tuckpointing reworks the mortar joints rather than removing and resetting masonry units. But the right answer depends on what has actually failed — paying to tuckpoint a wall full of spalled brick wastes money. An on-site look tells you which is truly cheaper over the long run."
  - q: "Can you tuckpoint over cracked or spalling brick?"
    a: "No. Tuckpointing renews the mortar joints, but it does nothing for brick that is cracked, flaking, or crumbling. New mortar around failing brick just hides the problem and lets water keep getting in. Damaged brick has to be cut out and replaced."
  - q: "How do I know if my brick is hollow or sound?"
    a: "Tap it firmly. Sound brick gives a sharp ring; failing brick sounds dull or hollow and may shed sand or flakes. Spalling — where the face pops off — is another clear sign the brick itself has failed and needs replacement, not just repointing."
  - q: "Do most older Chicagoland homes need both?"
    a: "Very often, yes. Decades of freeze-thaw weather usually wears the mortar joints first, but once water gets in, individual brick faces start to spall too. Many walls get the joints tuckpointed and a handful of bad brick swapped out in the same visit."
...
| Factor | Tuckpointing | Brick Replacement |
| --- | --- | --- |
| What has failed | The mortar joints | The brick units |
| What you see | Cracked, recessed, sandy, missing mortar | Spalling, cracking, flaking, hollow brick |
| Tap test | Brick rings solid | Brick sounds dull or hollow |
| Water concern | Joints let water in | Spalled face soaks water up |
| Scope | Renew joint lines | Cut out and reset units |
| Relative cost | Lower per square foot | Higher per brick |
| Longevity when done right | Decades on sound brick | Matches surrounding sound wall |
...
Call **(708) 288-1696** or [request a free on-site estimate](/#contact) today.
