---
title: "Tuckpointing in Riverside, IL — Soft Historic Brick Needs the Right Mortar, Not the Hardest One"
date: "2026-07-12"
primaryKeyword: "tuckpointing Riverside IL"
secondaryKeywords:
  - "tuckpointing riverside il"
  - "brick repointing riverside il"
  - "historic tuckpointing riverside illinois"
  - "lime mortar repointing riverside"
  - "mortar matching riverside il"
  - "crumbling mortar joints riverside"
  - "tuckpointing contractor riverside il"
  - "brick restoration riverside historic district"
  - "repointing victorian brick riverside"
  - "masonry contractor riverside il"
  - "tuckpointing near me riverside"
  - "soft brick repointing cook county"
city: "Riverside, IL"
...
faqs:
  - q: "How much does tuckpointing cost in Riverside, IL?"
    a: "There is no flat rate — the price depends on how many square feet of joint need repointing, the working height and access around Riverside's mature trees and tight lots, whether the mortar has to be matched to a historic lime mix, and how much of the brick face has already deteriorated. A single chimney or one elevation is a very different job from a whole 1890s house. We give you an itemized number after a free on-site look — call (708) 288-1696."
  - q: "Can you tuckpoint a historic home in Riverside's landmark district?"
    a: "Yes. Riverside's older homes were laid up in soft lime mortar, and they need to be repointed with a soft, lime-rich mortar that matches the original in strength, color, and joint profile. We match the historic mortar rather than forcing a hard modern mix into a wall that cannot tolerate it."
  - q: "Why is using hard modern mortar on old Riverside brick a problem?"
    a: "Mortar is designed to be the sacrificial, softer part of the wall. If you repoint century-old soft brick with a hard Portland-heavy mortar, the mortar will not yield to seasonal movement and trapped moisture — so the brick face spalls and flakes off instead. The repair then destroys the very brick it was meant to protect."
...
| What we match | Why it matters |
|---|---|
| **Compressive strength / lime content** | The new mortar must be no harder than the original, so the joint stays sacrificial |
| **Color** | Historic mortars pick up their color from local sand; a gray mix on a buff-sand wall reads as a scar |
| **Sand texture and aggregate** | Matches the grain and finish of the original joint |
| **Joint profile** | Concave, weathered, grapevine, struck — the profile is part of the home's character |
...
Mortar joints are the wall's water management system. Once they open up, water goes behind the brick and into the wall. In Chicagoland's freeze-thaw climate that water expands and contracts dozens of times each winter, and the damage escalates predictably: open joint → saturated brick → spalled brick face → displaced brick → structural repair. Tuckpointing is inexpensive next to [brick repair](/services/brick-repair) and [brick replacement](/services/brick-replacement), and it is a rounding error next to rebuilding a wall. Waiting only moves you up that ladder.

## Our Tuckpointing Process

1. **Assess and identify the mortar.** We look at what is actually in your joints — lime content, color, sand, profile — before we specify anything.
2. **Grind and rake the failed joints** to a proper depth, roughly two to two-and-a-half times the joint width, so the new mortar has something to key into. On soft historic brick we work carefully to avoid widening the joint or chipping the brick arris.
3. **Mix the matched mortar** and test it against the existing wall in an inconspicuous area.
4. **Repoint**, packing the joint fully and tooling it to the original profile.
5. **Cure properly** — historic and lime-rich mortars need to cure slowly and damp, not fast in the sun.
6. **Clean the brick face** and walk the finished work with you.
...
- **Condition of the [limestone sills and lintels](/services/limestone-sill-repair)** and whether the [chimney](/services/chimney-repair) needs work at the same time
...
We are used to landmark-district work: careful staging on narrow, curving streets, protecting mature landscaping, keeping the joint profile and mortar color faithful to the original so the house still reads as the house. If your project runs deeper than the joints, that is our [historic masonry restoration](/services/historic-masonry-restoration) work — and it is the same crew.

We also serve the neighboring villages: [tuckpointing in Brookfield](/locations/tuckpointing-brookfield-il), [masonry restoration in Berwyn](/locations/masonry-restoration-berwyn-il), and [historic masonry restoration in River Forest](/locations/historic-masonry-restoration-river-forest-il).
...
**Call Emerald Masonry LLC at [(708) 288-1696](tel:+17082881696)** or [request your free on-site estimate](/#contact). Learn more about our [tuckpointing and repointing service](/services/tuckpointing).
