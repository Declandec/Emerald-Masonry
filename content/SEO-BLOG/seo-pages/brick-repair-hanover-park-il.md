---
title: "Brick Repair in Hanover Park, IL — Spalling, Cracked, and Failing Brick Repair for 1970s–1990s Homes and Commercial Buildings"
date: "2026-06-03"
primaryKeyword: "brick repair Hanover Park IL"
secondaryKeywords:
  - brick replacement Hanover Park IL
  - spalling brick repair Hanover Park Illinois
  - brick veneer repair Hanover Park IL
  - masonry contractor Hanover Park IL
  - cracked brick repair DuPage County
  - brick repair contractor northwest suburbs Chicago
  - commercial brick repair Hanover Park IL
  - brick facade repair Hanover Park
...
Whether it's installing proper flashing, addressing a corroded lintel, or following up with [tuckpointing](/services/tuckpointing) of the surrounding joints, we close the path that let water reach the brick in the first place.

---

## What to Watch for on Your Hanover Park Building

- **Horizontal cracks above windows, doors, or garage openings** — almost always a lintel problem.
- **Flaking, crumbling, or popped brick faces** — spalling from trapped moisture; the brick is past saving and needs replacement.
- **Bowing or bulging wall sections** — possible tie failure; needs assessment.
- **Stair-step cracks** through the joints — movement or settlement.
- **Rust staining** running down from a lintel or shelf angle — corrosion in progress.
- **Loose or fallen brick** — a safety issue; address it immediately.

---

## Frequently Asked Questions

**Can you match my brick if it's from the 1980s and no longer made?**
Usually we can get a very close match. Many subdivision brick lines are discontinued, so we match by size, color range, and texture using the closest current product or salvage brick. On a repair section, a careful match blends well; we'll show you the match before we lay it.

**Why does the crack keep coming back above my window?**
That's the classic sign of a rusting steel lintel. The steel is expanding as it corrodes and pushing the brick up. Until the lintel is addressed, any brick repair over it will crack again. We fix the steel, then the brick.

**Is spalling brick a structural problem or just ugly?**
It depends on extent. A few spalled faces are cosmetic and a moisture flag. Widespread spalling, bowing walls, or spalling combined with cracking can indicate a larger water or structural problem. We'll tell you which one you have.

**Do you do both homes and commercial buildings in Hanover Park?**
Yes — single-family homes, townhome associations, and commercial buildings. We work directly with HOAs and property managers on multi-unit brick repair.
