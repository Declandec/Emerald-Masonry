---
title: "Tuckpointing in Elgin, IL — Mortar Joint Repair for the Fox River Valley's Historic and Modern Brick"
date: "2026-06-17"
primaryKeyword: "tuckpointing Elgin IL"
secondaryKeywords:
  - tuckpointing contractor Elgin IL
  - brick repointing Elgin Illinois
  - mortar joint repair Elgin IL
  - masonry tuckpointing Kane County
  - commercial tuckpointing Elgin
  - residential tuckpointing Elgin IL
  - historic brick repointing Elgin
  - tuckpointing company Elgin Illinois
city: "Elgin, IL"
...
Catch it at the joint stage and tuckpointing solves it. Wait until the brick is spalling and you have added [brick repair](/services/brick-repair) to the bill.

## How a Proper Job Is Done

1. **Assessment.** We identify which joints are failing and confirm the original mortar type so the new mortar matches.
2. **Removal.** Failed mortar is ground and raked out to the correct depth — deep enough for the new mortar to bond, without damaging the brick edges.
3. **Cleaning.** The joints are cleaned out so the new mortar adheres properly.
4. **Repointing.** Fresh mortar, matched in strength and color, is packed in and compacted.
5. **Tooling.** The joints are tooled to the right profile so they shed water and match the look of the wall.
...
We provide tuckpointing and repointing throughout Elgin and the surrounding Kane and DuPage County communities, including South Elgin, St. Charles, Bartlett, Streamwood, Hanover Park, and Carpentersville. From the historic brick near the Fox River and downtown Elgin to modern commercial buildings across the area, we match the mortar to the wall and do the job to last. We also handle full [masonry restoration](/services/masonry-restoration) when a building needs more than joint work.

## Get a Free Tuckpointing Estimate

If your mortar joints are recessing, crumbling, or letting water in, the time to act is before the brick starts to suffer. [Contact Emerald Masonry](/#contact) for a free on-site estimate in Elgin, or call **(708) 288-1696**. We will assess the joints, match the mortar, and give you a straight answer on what your wall needs.
