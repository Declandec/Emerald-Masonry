---
title: "Tuckpointing in Palos Heights, IL — Mortar Joint Repair From Your Local Masonry Company"
date: "2026-06-20"
primaryKeyword: "tuckpointing Palos Heights IL"
secondaryKeywords:
  - "tuckpointing contractor Palos Heights IL"
  - "brick repointing Palos Heights"
  - "mortar joint repair Palos Heights"
  - "masonry contractor Palos Heights IL"
  - "tuckpointing near me southwest suburbs"
  - "brick tuckpointing Cook County"
  - "chimney tuckpointing Palos Heights"
  - "brick repair Palos Heights IL"
  - "tuckpointing companies near Palos Heights"
  - "repointing brick Palos Heights"
  - "residential tuckpointing southwest Cook County"
...
1. **Assess.** We inspect the joints, the brick condition, and the existing mortar, then identify which areas need work and how deep the deterioration runs.
2. **Grind out the joints.** We carefully cut out the failed mortar to a proper depth — typically at least twice the joint width — without chipping the surrounding brick.
3. **Match the mortar.** We match the new mortar's color, texture, and type to your existing masonry, which matters most on older Palos Heights brick where the wrong mix is both ugly and damaging.
...
5. **Clean.** We clean down the brick face so the finished wall looks crisp, not smeared.
