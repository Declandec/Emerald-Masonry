---
title: "Tuckpointing in Western Springs, IL — Mortar Joint Repair for Tudor, Georgian, and Bungalow Brick Homes"
date: "2026-06-03"
primaryKeyword: "tuckpointing Western Springs IL"
secondaryKeywords:
  - brick repointing Western Springs IL
  - tuckpointing contractor Western Springs Illinois
  - mortar joint repair Western Springs
  - brick tuckpointing Cook County IL
  - chimney tuckpointing Western Springs IL
  - masonry contractor Western Springs IL
  - Tudor brick home tuckpointing Western Springs
  - residential tuckpointing west suburbs Chicago
...
- **Recessed joints** — the mortar has eroded back from the face of the brick, leaving a visible shadow line. If you can lay a pencil sideways into the joint, it's well past due.
- **Crumbling or sandy mortar** — when you scrape a joint with a key or screwdriver and it gives way to powder, the binder has failed.
- **Stair-step cracking** — diagonal cracks that follow the joints up a wall, often near corners, windows, or below the chimney.
- **Hairline gaps at the brick-to-mortar line** — early separation that lets water track behind the face.
- **Spalling brick faces** — when the face of a brick pops or flakes off, water has already been getting in. Spalling means the problem is no longer just mortar.
- **Efflorescence** — the white, chalky residue on the brick face is dissolved salts left behind by water moving through the wall. It's a moisture flag.

The through-line is water. Mortar joints are the weakest path into a masonry wall, and once they open up, every rain and every freeze drives the deterioration faster. The [tuckpointing repair](/services/tuckpointing) closes that path.
...
Joints are struck, brushed, and the wall is cleaned down. Where appropriate, we'll talk through whether a breathable masonry [waterproofing](/services/waterproofing) treatment makes sense after the mortar has cured — never a film-forming sealer that traps moisture in the wall.
...
- **Spalled or cracked brick** needs [brick replacement](/services/brick-repair) — cutting out the failed units and matching replacements, which on an older home means sourcing salvage or close-match brick.
- **Bowing or bulging walls** signal that the wall ties or the wall itself is failing — that's a structural assessment, not a cosmetic one.
- **Chimney deterioration** above the roofline is exposed on all sides and almost always the worst masonry on the house; it often needs [chimney repair](/services/chimney-repair) including crown and cap work, not just repointing.
- **Rusted steel lintels** over windows and doors lift and crack the brick above them as the steel corrodes and expands.
...
**How much of my house needs tuckpointing — can you do just one wall?**
Often, yes. South and west elevations and chimneys take the most weather and fail first, so partial repointing of the worst exposures is common and cost-effective. We'll show you what's failing and what can wait, rather than quoting the whole house by default.

**Will the new mortar match my existing brick and joints?**
On a visible elevation, that's the goal. We match the joint profile and color so the repair blends. A perfect invisible match on 100-year-old mortar is rarely possible, but a careful color match on a properly tooled joint is close enough that most people can't pick out the new work from the sidewalk.

**Why are some tuckpointing quotes so much lower than others?**
