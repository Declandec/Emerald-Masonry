---
title: "Limestone & Sill Repair in Oak Park, IL — Stone Restoration for Historic Homes & Greystones"
date: "2026-06-18"
primaryKeyword: "limestone sill repair Oak Park IL"
secondaryKeywords:
  - limestone sill repair contractor Oak Park IL
  - stone sill restoration Oak Park Illinois
  - greystone repair Oak Park
  - limestone band course repair Oak Park IL
  - window sill stone repair Oak Park
  - Dutchman stone repair Oak Park IL
  - historic masonry stone repair Oak Park
  - limestone lintel and sill restoration Oak Park
  - cut stone repair near River Forest
  - greystone facade restoration Oak Park Illinois
city: "Oak Park, IL"
...
1. **Assessment** — we examine each sill and band, identify which are sound, which need partial repair, and which are beyond saving.
2. **Dutchman repairs** — for localized damage, the failed portion is cut out cleanly and a matching piece of new stone is shaped and set in, preserving the rest of the original.
3. **Full sill replacement** — where a stone is broken through or extensively deteriorated, we replace it with matched stone, properly bedded and sloped to shed water.
4. **Joint repair and sealing** — surrounding joints are repointed or re-caulked with appropriate, breathable materials so water sheds rather than gets trapped.
5. **Cleanup and matching** — the finished repair blends with the existing facade in color and texture.

When the surrounding brick has also suffered, we fold in [brick repair](/services/brick-repair) and [tuckpointing](/services/tuckpointing) so the whole elevation is watertight, not just the stone.
