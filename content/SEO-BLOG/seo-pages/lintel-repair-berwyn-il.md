---
title: "Lintel Repair in Berwyn, IL — Rusting Steel Lintel Repair for Bungalows & Two-Flats"
date: "2026-06-18"
primaryKeyword: "lintel repair Berwyn IL"
secondaryKeywords:
  - lintel repair contractor Berwyn IL
  - steel lintel replacement Berwyn Illinois
  - rusted lintel repair Berwyn
  - window lintel repair Berwyn IL
  - rust jacking repair Berwyn
  - bungalow lintel repair Berwyn Illinois
  - two-flat lintel replacement Berwyn
  - horizontal crack brick repair Berwyn IL
  - masonry lintel contractor near Cicero
  - angle iron lintel repair Berwyn Illinois
city: "Berwyn, IL"
...
faqs:
  ...
  - q: "What is rust jacking and why does it crack my brick?"
    a: "Steel lintels rust when water gets to them, and rust takes up far more volume than the original steel. As the lintel expands, it lifts and pushes the masonry above it — that's rust jacking. The pressure opens horizontal cracks, displaces brick, and over time can let the wall above the window become unstable if it isn't addressed."
  - q: "Can a rusted lintel be repaired, or does it have to be replaced?"
    a: "It depends on how far the rust has gone. Surface rust caught early can sometimes be cleaned, treated, and protected. A lintel that has lost section to corrosion, is sagging, or has already cracked the brick generally needs replacement, with the brick above carefully supported and rebuilt. We assess each opening and recommend the durable fix."
  - q: "Do you rebuild the brick above the lintel too?"
    a: "Yes. Replacing a lintel almost always means temporarily supporting and removing the courses of brick above it, swapping the steel, then relaying the brick and repointing. We match the brick and mortar so the rebuilt section blends with the rest of your Berwyn home's facade."
...
1. **Inspection** — we evaluate the lintel, the cracking pattern, and how far the rust and displacement have progressed.
2. **Shoring** — where the lintel is being replaced, the brick above the opening is temporarily supported so the wall stays safe during the work.
3. **Lintel treatment or replacement** — surface rust caught early can be cleaned, treated, and protected; a corroded or sagging lintel is removed and replaced with new, properly primed steel.
4. **Brick rebuild** — displaced and cracked brick above the opening is removed and relaid on the new lintel.
5. **Repointing and sealing** — joints are repointed and the window head is re-caulked so water stays out and the new steel lasts.

When the surrounding wall has also taken damage, we bring in [brick replacement](/services/brick-replacement) for spalled units and [tuckpointing](/services/tuckpointing) to restore the joints across the elevation. Re-sealing the openings with proper [caulking](/services/caulking) is what keeps the new lintel from rusting all over again.
