...
keywords:
  ...
  - curtain wall joint sealant
  - commercial building leaking not roof
  - precast concrete panel repair Chicago
  - building envelope failure Chicagoland
  - expansion joint sealant commercial
  - panel joint caulking Oak Brook
  - office building facade repair Chicago suburbs
  - spalled precast concrete edge repair
  - embedded steel corrosion precast
  - shelf angle repair commercial
  - through-wall flashing masonry
  - EIFS joint failure
  - brick veneer commercial repair
  - parapet wall repair commercial
  - coping stone joint sealant
  - window perimeter sealant failure
  - property manager building envelope
  - HOA condominium facade repair
  - capital reserve study masonry
  - commercial masonry restoration Chicago
  - tuckpointing commercial building
  - efflorescence commercial facade
  - freeze-thaw damage precast concrete
  - swing stage facade repair
  - rust jacking embedded steel
  - masonry sealing waterproofing commercial
...
faqs:
  - q: "My building is leaking but the roof was just replaced — where is the water coming from?"
    a: "On a precast, panel or curtain wall building, failed perimeter and panel joint sealant is the most common answer. The joints are the weather barrier, so once sealant loses adhesion water enters the wall assembly and travels before it appears inside, often several floors below and well away from the actual entry point. This is one of the most frequently misdiagnosed commercial leaks."
  - q: "How is a precast panel building different from a brick building?"
    a: "A traditional masonry wall manages water through mass and a drainage cavity, and it is fairly forgiving of small defects. A precast or curtain wall building is a system of discrete units hung on a structure, and the sealed joints between them are the primary barrier — there is much less redundancy, so a failed joint becomes a leak much faster."
  - q: "How often do precast panel joints need to be resealed?"
    a: "Sealant is a wear item with a service life considerably shorter than the building, and exterior joints generally need replacing well before anything else on the facade does. Sun exposure and joint movement drive it, so south and west elevations typically fail first. Property managers get the best results inspecting on a defined cycle rather than reacting to tenant complaints."
  - q: "What does it cost to reseal a commercial building facade?"
    a: "Cost is driven mainly by linear footage of joint, height and access method, how difficult the old sealant is to remove, and whether substrate repairs are needed first. Access — swing stage, boom lift or scaffold — is frequently the largest single line item on a multi-story building. Emerald Masonry assesses in person and provides a written scope suitable for budgeting and board approval."
  - q: "Can facade work be done while tenants stay in the building?"
    a: "Yes, and it almost always is. Envelope work on occupied commercial buildings is routinely staged with protected walkways, phased elevations, and noisy or access-blocking work scheduled around business hours. Coordination with property management before mobilizing is part of the job."
  - q: "What is spalling on a precast concrete panel?"
    a: "It is concrete breaking away from the panel surface or edge, usually because water reached the embedded reinforcing steel and corroded it. Corroding steel expands to several times its original volume, and that pressure breaks the concrete off from within. Rust staining on a panel is the early warning that this process has started."
  - q: "Is efflorescence on a commercial facade a serious problem?"
    a: "It is a symptom that water is actively moving through the assembly, which on a panel or veneer building usually points back to a joint. The staining itself is cosmetic; what it indicates is not. It is worth tracing to the entry point rather than cleaning off and forgetting."
  - q: "Should we include facade work in our reserve study?"
    a: "Yes — joint sealant, facade repair and parapet work are predictable recurring capital items with finite service lives, and associations and building owners who fund them on a cycle spend far less than those who wait for leaks. A written condition assessment gives the reserve study real numbers rather than placeholders."
  - q: "Who should we call — a roofer, a mason, or a waterproofing contractor?"
    a: "If the leak is at or near an exterior wall and the roof is sound, the envelope is the place to start, which means a contractor who works on joints, masonry and facade assemblies. The best outcome usually involves coordination, since the roof membrane, counterflashing and parapet masonry all meet at the same detail. Emerald Masonry assesses commercial envelopes across Chicagoland; call (708) 288-1696."
---
...
| | Traditional masonry | Precast / panel / curtain wall |
|---|---|---|
| **Primary barrier** | Wall mass + drainage cavity | Sealed joints |
| **Redundancy** | High | Low |
| **Small defect result** | Usually absorbed | Often an interior leak |
| **Failure location** | Distributed across the wall | Concentrated at joints |
| **Repair focus** | Repointing, unit replacement | Joint replacement, substrate, embedded steel |
| **Service-life driver** | Mortar (decades) | Sealant (a wear item) |
...
7. **Check the top of the wall.** Coping, [parapet](/services/parapet-wall-repair) condition and through-wall flashing — the parapet is exposed on both faces and carries the roof's water, so it fails first and leaks into the wall below.
...
Related work: [caulking and joint sealant](/services/caulking), [commercial masonry restoration](/services/commercial-masonry-restoration), [parapet wall repair](/services/parapet-wall-repair), [tuckpointing](/services/tuckpointing), [lintel repair](/services/lintel-repair) and [masonry sealing](/services/masonry-sealing).
