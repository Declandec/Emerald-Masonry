...
keywords:
  - brick arch repair
  - sagging jack arch window
  - flat arch brick repair Chicago
  - segmental arch masonry repair
  - keystone dropped brick arch
  - brick arch rebuild Chicagoland
  - arch bar rusted masonry
  - lintel vs arch brick opening
  - cracked brick above window
  - brick sagging over door
  - greystone window arch repair
  - two-flat brick arch restoration
  - soldier course above window
  - masonry arch thrust and abutment
  - shoring and centering arch repair
  - historic masonry restoration Chicago
  - repointing arch joints
  - lime mortar arch repair
  - Type N mortar brick arch
  - salvaged brick arch rebuild
  - spalling brick above window
  - step cracks above opening
  - efflorescence around window head
  - steel lintel replacement Chicago
  - rust jacking brick arch
  - freeze-thaw brick damage Illinois
  - bowing brick wall
  - Chicago bungalow window repair masonry
...
faqs:
  - q: "Is a sagging brick arch over my window dangerous?"
    a: "It should be treated as urgent, though not usually as an immediate collapse risk. A sagging arch has already lost some of its ability to carry the wall above it, and that load is being redistributed into masonry that was not designed for it. Have it assessed promptly rather than watching it through another winter."
  - q: "What is the difference between an arch and a lintel?"
    a: "A lintel is a beam — usually steel on Chicago-area buildings — that spans the opening and carries the load across it. An arch carries load by compression, pushing outward and downward into the masonry on either side. They fail differently, and an arch cannot simply be repointed back into working order once it has moved."
  - q: "Why is the brick above my window cracked in a stair-step pattern?"
    a: "Stepped cracking above an opening usually means the arch or its supporting masonry has moved. Common causes are eroded joints letting the arch bricks slip, a corroding steel arch bar or lintel behind the brick, or settlement below the opening that has shifted what the arch bears on."
  - q: "Can a sagging arch just be repointed?"
    a: "Only if it has not actually moved. Once the wedge-shaped units have slipped and the arch geometry has changed, packing new mortar into the open joints locks in the deformation instead of correcting it. A moved arch has to be shored, taken apart and rebuilt to its original line."
  - q: "What is an arch bar and why does it matter?"
    a: "Many flat or jack arches on Chicago buildings were built with a steel bar hidden behind or beneath the brick to help carry the span. When that bar rusts it expands to several times its thickness and pushes the arch bricks out and down, which is why an arch can fail even though the masonry itself looks sound."
  - q: "Do I need a permit to rebuild a brick arch?"
    a: "It depends on your municipality and whether the property is in a landmark or historic district. Structural masonry work over an opening is frequently permitted work, and district review may apply to the appearance of the rebuilt arch. We identify what applies as part of the assessment."
  - q: "How much does brick arch repair cost in Illinois?"
    a: "It is driven by whether the arch can be repaired in place or must be rebuilt, whether shoring is required, access and height, whether hidden steel has to be replaced, and how difficult the brick is to match. A single ground-floor arch and a full elevation of upper-story arches are very different jobs. Estimates are free and written."
  - q: "Can the original brick be reused when rebuilding an arch?"
    a: "Usually a good portion of it, yes, and that is preferable — original brick matches the surrounding wall in a way new brick cannot. Units that have spalled or cracked through are replaced with the closest available match and blended so the rebuilt arch reads as original."
  - q: "Why did my arch fail when the rest of the wall looks fine?"
    a: "Because an arch is the most highly stressed masonry on the elevation. It concentrates the load of everything above the opening into a small number of units and their joints, so mortar erosion or minor movement that a flat wall would tolerate is enough to compromise an arch."
  - q: "How long does an arch rebuild take?"
    a: "A single arch, once shored and formed, is typically a matter of days rather than weeks, but the mortar has to cure before shoring comes out, and weather affects that. Larger jobs with multiple openings, staging or hidden steel replacement take proportionally longer."
---
...
Related services that commonly run with arch work: [brick repair](/services/brick-repair) and [brick replacement](/services/brick-replacement), [tuckpointing and repointing](/services/tuckpointing), [lintel repair](/services/lintel-repair), [limestone and sill repair](/services/limestone-sill-repair), and [historic masonry restoration](/services/historic-masonry-restoration).
