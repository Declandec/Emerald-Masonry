---
title: "How Trees and Their Roots Damage Masonry Foundations, Chimneys, and Walls"
date: "2026-06-21"
...
keywords:
  ...
  - roots cracking foundation Chicago
  - tree near foundation brick damage
  - soil moisture foundation cracks Illinois
  - overhanging trees chimney damage
  - tree root masonry repair Chicagoland
  - foundation crack from tree
aiSummary: "Trees damage masonry in three main ways: roots and the soil-moisture swings they cause crack and shift foundation walls, overhanging limbs trap moisture and drop debris that accelerates chimney and roof masonry decay, and shaded damp walls hold water that feeds freeze-thaw spalling. Emerald Masonry LLC repairs the masonry and advises on the cause. Free estimates — call (708) 288-1696."
intent: "informational"
faqs:
  - q: "Can tree roots really crack a masonry foundation?"
    a: "Yes, though often indirectly. Roots rarely punch through a sound wall, but they dry out and shrink the soil around a foundation, causing it to settle unevenly and crack — and they can exploit and widen existing cracks. In Chicago's clay soils, this soil-moisture effect is the bigger driver of foundation movement near large trees."
  - q: "How far should a large tree be from my foundation?"
    a: "A common guideline is to keep large species at least as far from the house as their mature height, though this varies by species and soil. The point isn't a magic number — it's that big, thirsty trees close to the house drive the soil-moisture swings that move foundations. An arborist and a mason together can assess a specific tree."
  - q: "Do overhanging tree limbs damage a chimney?"
    a: "They can. Limbs over a chimney keep the masonry shaded and damp so it dries slowly and spalls faster, drop leaves and debris that hold moisture against the crown and flashing, and in storms can strike the stack directly. Keeping limbs clear of the chimney is cheap insurance against accelerated masonry decay."
  - q: "Should I remove a tree to stop foundation damage?"
    a: "Not necessarily, and removing a large tree can sometimes cause its own soil-heave problems. The right move is to diagnose whether the tree is actually driving the damage, then address the masonry and the moisture conditions. We repair the foundation; an arborist advises on the tree — the two decisions work best together."
---
...
- New or widening **step cracks** in basement or foundation walls, especially on the side nearest a big tree
- Cracks that **open and close with the seasons** — a classic sign of clay soil moving
- Doors and windows that stick in summer and free up in other seasons
- Foundation movement concentrated near a single large, close tree
...
- **Drop leaves and debris** that collect on the chimney crown, in the flashing, and against the parapet, holding moisture right where it does the most harm
- **Keep the chimney shaded and damp**, so it dries slowly and spalls faster
- **Scrape and strike** the stack and roofline in wind, and in storms can break off and hit the chimney directly
- **Feed gutter clogs** that send overflow cascading down brick walls
...
2. **Fix the masonry properly.** Step cracks get [foundation masonry repair](/services/foundation-masonry-repair) — repointing, crack repair, and rebuilding where needed. Spalled brick gets [brick replacement](/services/brick-replacement). Chimney damage gets [chimney repair](/services/chimney-repair).
