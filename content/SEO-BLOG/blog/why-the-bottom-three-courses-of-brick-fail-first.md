---
title: "Why the Bottom Three Courses of Brick Always Fail First"
date: "2026-08-13"
excerpt: "Walk any older Chicagoland block in March and the damage is at ankle height — spalled faces, crusty white deposits, crumbling joints in the lowest courses while the wall above looks fine. Five separate forces converge in that eighteen inches, and four of them are things you can actually do something about."
...
keywords:
  ...
  - bottom courses of brick failing
  - why is my brick crumbling at the bottom
  - splash back brick damage
  - road salt damage brick
  - salt crystallization masonry
  - rising damp masonry
  - snow banking against wall
  - grade too high against brick
  - water table masonry
  - efflorescence at base of wall
  - freeze-thaw brick damage Illinois
  - foundation masonry repair Chicagoland
  - parging foundation
  - brick replacement at grade
  - tuckpointing lowest courses
  - downspout extension foundation
  - grading slope away from house
  - weep holes brick veneer
  - deicer damage concrete brick
  - Chicago bungalow water table
  - two-flat base course repair
...
faqs:
  - q: "Why is only the bottom of my brick wall crumbling?"
    a: "Because that zone gets wet more often and stays wet longer than anything above it. Splash-back, snow banked against the wall, salt spray, and moisture from the soil all concentrate in the lowest courses, so they enter every freeze-thaw cycle saturated while the wall above has already dried."
  - q: "Does road salt really damage brick?"
    a: "Yes, and by two mechanisms. Salt-laden water is drawn into the masonry and then crystallizes as it dries, and those growing crystals exert pressure inside the pores much like freezing water does. It also lowers the freezing point in a way that increases the number of damaging wet-freeze cycles at the base of the wall."
  - q: "What are the white crusty deposits at the bottom of my wall?"
    a: "Usually a mix of efflorescence and de-icing salt residue. Efflorescence is mineral salt carried out of the masonry by water and left behind as it evaporates, which proves water is moving through. Heavy crusty deposits low on a wall in late winter typically point to road salt as well."
  - q: "How high should soil or mulch be against my brick?"
    a: "Below the top of the foundation, with a visible gap so the masonry above grade stays clear. Soil and mulch piled against brick hold moisture directly against it continuously and prevent the wall from drying — one of the most common and easiest-to-fix causes of base-course damage."
  - q: "Can I just replace the damaged bricks at the bottom?"
    a: "You can, and often should, but only after correcting what is keeping that zone wet. Replacing units while splash, salt and standing water keep arriving means the new brick starts on the same clock. Fix the water first, then replace."
  - q: "Should I seal the bottom of my wall?"
    a: "Only with a breathable, vapor-permeable product, and only after joints are sound and the water sources are corrected. A film-forming coating at grade traps moisture in the wettest masonry on the building and spalls the faces from behind, which is the opposite of what you wanted."
  - q: "Is damage at grade a foundation problem?"
    a: "Sometimes, and it is worth distinguishing. Spalling faces and eroded joints in the courses above grade are usually a wetting problem; stair-step or horizontal cracking, bowing, or mortar washing out of the foundation itself indicate movement or a different water issue that needs proper assessment."
  - q: "Why does it look worse in late winter?"
    a: "Because that is when the cumulative damage from the season becomes visible — weeks of snow banked against the wall, repeated salting, and dozens of freeze-thaw crossings all land in those bottom courses. March is when most homeowners first notice it, though the damage accrued all winter."
  - q: "What does repair at grade cost?"
    a: "It depends on how many units need replacing, how much joint work is involved, whether parging or drainage correction is needed, and access. Work at grade is generally cheaper than upper-elevation repair because no staging is required. Emerald Masonry gives free on-site estimates."
---
...
1. **Move the snow.** Shovel away from the foundation rather than against it. This single habit change is free.
2. **Cut back the soil and mulch.** Get them below the top of the foundation with a visible gap of exposed masonry above.
3. **Extend the downspouts** well clear of the wall, and keep gutters clear so they are not overflowing into that zone.
4. **Correct the grade** so it slopes away from the house for the first several feet.
5. **Use less salt near masonry.** Shovel promptly instead, or switch de-icer on walks immediately adjacent to brick.
6. **Then repair the masonry** — repointing, unit replacement, parging — once the water has somewhere else to go.

**Doing step six first is how people end up paying for it twice.**

## How the Repair Is Done

1. **Free on-site assessment.** We identify which of the five forces are active on your wall, and distinguish surface deterioration from foundation movement.
2. **Correct the water sources**, or tell you what to correct.
3. **Rake out failed joints** to sound depth.
4. **Cut out spalled units**, freeing them by cutting the surrounding mortar rather than attacking the brick, so neighbors stay intact.
5. **Set matched replacements** — matched for size, color, texture and, critically, **absorption and hardness**.
6. **Repoint** with mortar matched to the wall. **The governing rule is that mortar must be softer than the brick it holds**, so joints take the stress instead of the faces. **Type N** for most above-grade work, **Type S** where at-grade and below-grade conditions warrant.
7. **Parge** the exposed foundation where appropriate, to shed water and protect the masonry.
8. **Breathable protection only**, if anything — never a film-forming coating at grade, which traps moisture in the wettest masonry on the building.
...
**Movement** — stair-step cracking, horizontal cracking, bowing, or mortar washing out of the foundation itself — indicates soil pressure or settlement and needs proper evaluation before any cosmetic repair. See [foundation masonry repair](/services/foundation-masonry-repair).

## Related Services

[Brick repair](/services/brick-repair), [brick replacement](/services/brick-replacement), [tuckpointing and repointing](/services/tuckpointing), [foundation masonry repair](/services/foundation-masonry-repair) and [masonry sealing](/services/masonry-sealing).
