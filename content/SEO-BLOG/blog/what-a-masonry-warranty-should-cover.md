---
title: "What a Masonry Warranty Should Cover — And What Most of Them Don't"
date: "2026-04-25"
...
keywords:
  ...
  - masonry contractor warranty Chicagoland
  - what does masonry warranty cover
  - masonry repair warranty terms Illinois
  - tuckpointing warranty period Chicago
  - masonry contractor guarantee Illinois
  - brick repair warranty terms
  - masonry workmanship warranty Chicago
  - commercial masonry warranty property manager
---
...
- Mortar that debonds from the masonry within the warranty period
- Joints that crack or fall out significantly before the normal service life of the mortar
- Mortar installed at inadequate depth that fails to bond properly
- Work performed in conditions (below 40°F, in direct rain) that caused the mortar to fail
...
- **Defined scope.** Exactly what work is covered — which elevations, which joint areas, which elements.
- **Clear warranty period.** 3-5 years for commercial tuckpointing is a strong term.
- **Defined exclusions.** Honest, specific exclusions rather than catch-all language. "Settlement and structural movement" is reasonable. "Any failure related to water in any form" is too broad.
- **Transferability.** Can the warranty transfer to a new property owner if the building is sold during the warranty period? For commercial properties, this matters.
- **Claim process.** How to file a claim, who to contact, what the response timeline is.
- **Contractor contact information.** Seems obvious, but some warranty documents omit current contact information — making claims practically difficult.
