---
title: "How Road Salt and De-Icers Destroy Brick Steps, Stoops, and Foundations in Illinois"
date: "2026-06-18"
...
keywords:
  ...
  - salt damage brick steps
  - spalling brick from salt
  - brick stoop repair Chicago
  - de-icing chemical brick foundation
  - salt scaling masonry
  - protect brick steps winter Illinois
  - efflorescence from salt brick
  - masonry repair after salt damage
aiSummary: "Road salt and chloride de-icers damage Illinois brick by driving salt into the masonry, where repeated crystallization and freeze-thaw cycles spall the brick face and erode mortar joints — worst on steps, stoops, and at-grade foundation walls. Emerald Masonry LLC repairs salt-damaged brick and recommends safer de-icers and sealing. Free estimates — call (708) 288-1696."
intent: "informational"
faqs:
  - q: "Does road salt really damage brick and concrete masonry?"
    a: "Yes. Chloride de-icing salts soak into porous brick and mortar, then crystallize and expand as they dry and re-wet, breaking the masonry apart from within — a process called salt scaling. Combined with freeze-thaw cycling, it spalls brick faces and erodes mortar joints, especially on steps, stoops, and at-grade walls that get salted directly."
  - q: "What's a safer de-icer for brick steps and stoops?"
    a: "Calcium magnesium acetate (CMA) is the gentlest common option for masonry. Sand provides traction with no chemical attack at all. Avoid rock salt (sodium chloride) and minimize calcium chloride and magnesium chloride directly on brick. Whatever you use, shovel first and apply sparingly so less chemical sits on the masonry."
  - q: "Can salt-damaged brick be repaired, or does it need replacing?"
    a: "Brick that has spalled — lost its hard outer face — needs replacing, because the exposed core absorbs salt and water even faster. Eroded mortar joints can be repointed. The key is to also address why salt is reaching the masonry and to consider a breathable sealer once repairs are done."
  - q: "Will sealing brick protect it from salt damage?"
    a: "A proper breathable masonry sealer reduces how much salt-laden water the brick absorbs, which helps. But sealing is not a license to keep dumping rock salt on the steps — it slows absorption, it doesn't make brick salt-proof. The best protection is reducing salt exposure plus sealing clean, sound, dry masonry."
---
...
- **Front and back steps and stoops.** These take direct, repeated salting all winter and are the number-one casualty. Brick treads and risers spall, and mortar washes out.
- **At-grade foundation walls and the bottom courses of brick.** Salt-laden snowmelt pools against the base of the wall, wicks up, and concentrates there. The lowest few courses often deteriorate first.
- **Walkway and driveway edges where brick meets pavement.** Plowed and shoveled salty slush gets piled against adjacent brick.
- **Garage aprons and brick planters near the drive.** Anywhere salt spray and runoff land.
- **Brick near downspout discharge** that's also in the salt zone — double the water.
...
- **Shovel first, salt second.** Removing snow mechanically means you need far less chemical. Most over-salting is compensation for not clearing the surface first.
- **Choose a gentler de-icer.** Rock salt (sodium chloride) is the cheapest and the hardest on masonry. **Calcium magnesium acetate (CMA)** is the most masonry-friendly common product. Plain **sand** adds traction with zero chemical attack. Calcium chloride and magnesium chloride work at lower temperatures but should still be used sparingly directly on brick.
- **Apply less, more deliberately.** De-icers work by melting a thin layer to break the ice bond — you don't need a heavy coat. More salt isn't more safety; it's just more chemical sitting on your brick.
- **Direct water away.** Make sure downspouts discharge well past brick steps and foundation walls so salty meltwater isn't pooling against the masonry.
- **Seal sound masonry.** A quality **breathable** masonry sealer reduces how much salt-laden water the brick drinks in, while still letting the wall release vapor. Crucially, sealer goes onto clean, dry, sound masonry — sealing over already-damaged or wet brick traps the problem inside. (See our [masonry sealing](/services/masonry-sealing) service.)
...
2. **Replace failed brick** with [matched brick](/services/brick-repair), since salt-spalled units won't recover.
