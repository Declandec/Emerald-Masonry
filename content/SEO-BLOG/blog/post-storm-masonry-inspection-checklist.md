---
title: "Post-Storm Masonry Inspection Checklist for Commercial Property Managers"
date: "2026-04-12"
...
keywords:
  ...
  - wind damage brick wall Illinois
  - masonry inspection after storm Chicago
  - hail damage brick building inspection
  - commercial property storm damage assessment
  - masonry insurance claim Illinois
  - brick building storm assessment checklist
  - parapet storm damage inspection
---
...
- **Displaced masonry on the ground.** Fallen brick, coping units, or chimney material is a sign that something above is structurally unstable. Do not stand beneath damaged sections.
- **Visible parapet lean or displacement.** If a parapet section looks out of plumb from a distance, treat the area below as a restricted zone until it's inspected up close.
- **Overhead power lines.** If any masonry material has fallen near lines, don't approach — call the utility company first.
...
- [ ] Are any coping units displaced, shifted, or missing?
- [ ] Is the parapet line visibly out of plumb on any section?
- [ ] Is there visible cracking in the top 12–18 inches of the parapet wall?
- [ ] Are there any sections where brick units appear to be pushing outward?
- [ ] Is there debris at the base of the wall below the parapet (loose mortar, fragments of coping, brick chips)?
...
- [ ] Is the chimney stack still plumb and intact?
- [ ] Is there brick or mortar debris at the base of the chimney?
- [ ] Is any section of the chimney visibly offset from the course below?
- [ ] Has the chimney cap (crown) moved, cracked, or been displaced?
- [ ] If the chimney passes through the roof, check the interior ceiling near the chimney for water staining after the storm.
...
**Exterior:**
- [ ] Is there fresh mortar debris or crumbling at the base of any wall section? (indicates joints have failed under storm pressure)
- [ ] Are there any new visible cracks in the wall face that weren't there before?
- [ ] Are there sections with brick units that appear pushed outward from the wall plane?

**Interior (check immediately adjacent to exterior walls):**
- [ ] Water staining on interior walls or ceiling near exterior wall?
- [ ] Wet or damp floor adjacent to exterior masonry?
- [ ] Any active dripping at window or door frames adjacent to masonry walls?
...
- [ ] Any new cracking visible in brick immediately above window openings?
- [ ] Mortar debris below window openings?
- [ ] Water infiltration around window frames from the interior?
- [ ] Any window frames that appear to have shifted or racked?
...
- [ ] Are expansion joints (vertical open joints, typically filled with dark caulk) still intact?
- [ ] Is there water infiltration at interior locations near expansion joint lines?
...
- Displaced or fallen coping units
- Chimney displacement or visible structural instability
- Any masonry with brick units pushed outward from the wall plane
- Active interior water infiltration in occupied spaces

**Schedule within 1–2 weeks:**
- New surface cracks without displacement or infiltration
- Mortar debris at grade without visible wall damage
- Post-storm efflorescence (white staining)
- Window frame infiltration without interior structural damage

**Document and monitor:**
- Interior water staining that appears minor and doesn't recur — this may be existing pre-storm deterioration, not new storm damage. Note the location and compare after the next rain event.
