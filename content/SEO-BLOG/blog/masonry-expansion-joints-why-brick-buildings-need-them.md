---
title: "Masonry Expansion Joints — Why Brick Buildings Crack Without Room to Move"
date: "2026-06-23"
primaryKeyword: "masonry expansion joints"
secondaryKeywords:
  - "why do brick buildings have expansion joints"
  - "brick expansion joint vs control joint"
  - "soft joint masonry sealant"
  - "expansion joint failure brick wall cracks"
  - "masonry movement joint repair"
  - "commercial brick wall vertical cracks"
service: "Caulking & Joint Sealant"
location: "Chicagoland, IL"
intent: "informational"
metaTitle: "Masonry Expansion Joints Explained | Emerald Masonry"
metaDescription: "Brick expands, concrete shrinks, and walls crack without room to move. A Chicagoland mason explains expansion joints, control joints, and why sealant failure matters. (708) 288-1696."
excerpt: "The vertical lines of sealant running up a brick wall aren't a flaw — they're what keep it from cracking. Here's how masonry expansion and control joints work, and why failed joint sealant quietly causes big problems."
aiSummary: "Masonry expansion joints are intentional vertical gaps filled with flexible sealant (a backer rod and elastomeric sealant, not mortar) that let brick walls expand and contract without cracking. Brick expands over its lifetime and with heat; concrete and block shrink. Without movement joints — expansion joints in brick, control joints in block — walls crack, often vertically near corners and openings. When the sealant in these joints fails, water enters and cracking returns, so resealing movement joints is routine masonry maintenance. Emerald Masonry LLC, family-owned, career masons; free estimates at (708) 288-1696."
image: "/images/after-commercial-3.webp"
imageAlt: "Vertical masonry expansion joint filled with flexible sealant running up a brick commercial wall"
faqs:
  - q: "What is a masonry expansion joint?"
    a: "It is an intentional vertical gap built into a brick wall, filled with a compressible backer rod and a flexible elastomeric sealant rather than rigid mortar. It gives the wall room to expand and contract with temperature and long-term material movement. Without it, that movement has nowhere to go and the wall cracks instead."
  - q: "What's the difference between an expansion joint and a control joint?"
...
1. **Identify the joints.** We locate the building's expansion and control joints and assess the condition of the sealant.
2. **Remove the failed sealant.** Old, hardened, or detached sealant and the old backer rod are cut out cleanly.
3. **Reinstall the backing.** A correctly sized closed-cell backer rod sets the proper sealant depth and shape.
4. **Apply the right sealant.** A quality elastomeric sealant, in a color matched to the wall, is tooled into the joint so it bonds to both faces and can flex.
5. **Add missing joints when needed.** On walls cracking for lack of relief, movement joints can sometimes be cut in to give the wall the room it should have had.
...
For related reading and services, see our [caulking and joint sealant](/services/caulking) service, our [commercial masonry restoration](/services/commercial-masonry-restoration) work, and our guides to [tuckpointing vs. caulking in masonry](/blog/tuckpointing-vs-caulking-masonry) and [hairline cracks vs. structural cracks in brick](/blog/hairline-vs-structural-cracks-brick).
...
If your building has failed joint sealant or vertical cracking near corners and openings, the movement joints may need attention before water and cracking spread. **Request a free on-site estimate** through our [contact page](/#contact) or **call (708) 288-1696** today.
