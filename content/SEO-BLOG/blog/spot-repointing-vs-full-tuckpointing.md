---
title: "Spot Repointing vs. Full Tuckpointing — When Patching Saves Money and When It Wastes It"
date: "2026-06-17"
...
keywords:
  ...
  - when to repoint whole wall
  - masonry repointing scope
  - tuckpointing estimate Chicago
  - cost-effective mortar repair
  - brick repointing decision
  - masonry repair budget property manager
---
...
1. **Ask what percentage of the joints are actually failing.** If it is a small, contained share, spot repointing is reasonable. If it is most of the wall, lean toward full.
2. **Ask about the access line.** Find out how much of the cost is getting to the wall versus doing the work. That tells you whether "do it all now" is genuinely cheaper than phasing.
3. **Ask about mortar matching.** Spot repointing only works well if the new mortar matches the old in strength and color. If they cannot match it confidently, the spot work will stand out and may not perform the same.
4. **Ask what they would do on their own building.** A straight contractor will tell you when spot work is enough and when it is throwing good money after bad.

For more on reading the whole document, our guide on [how to read a masonry contractor's scope of work](/blog/how-to-read-masonry-scope-of-work) breaks down the line items, and [how to evaluate a masonry contractor bid](/blog/how-to-evaluate-masonry-contractor-bid) covers comparing competing proposals.
...
When the foundational work of [tuckpointing](/services/tuckpointing) is matched to what the wall genuinely needs — and the mortar is matched to the wall — both spot and full repointing do exactly what they should.
