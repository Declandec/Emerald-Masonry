---
title: "How to Spot a Bad Tuckpointing Job: Red Flags Every Chicago Homeowner Should Check"
date: "2026-07-09"
excerpt: "A bad tuckpointing job hides in plain sight — smeared mortar, wrong colors, and shallow grinding that fails in a season or two. Here's how to inspect the work like a mason and know whether you got what you paid for."
...
keywords:
  ...
  - "signs of bad tuckpointing"
  - "tuckpointing quality"
  - "tuckpointing done wrong"
  - "mortar smearing on brick"
  - "wrong mortar color"
  - "joint profile"
  - "grinding depth"
  - "repointing"
  ...
  - "mortar matching"
  - "feathering mortar"
  - "tuckpointing inspection"
  - "how to inspect tuckpointing"
  - "tuckpointing red flags"
  - "hard mortar soft brick"
  - "spalling brick"
  ...
  - "masonry sealing"
faqs:
  - q: "What does a bad tuckpointing job look like?"
    a: "A bad tuckpointing job shows mortar smeared across the brick faces, joints that don't match the original color or profile, and a thin skim of new mortar riding on top of old material instead of packed into a ground-out joint. You'll often also see cracked or hazy brick faces from acid or grinder overreach."
  - q: "How deep should mortar be ground out for tuckpointing?"
    a: "A proper repointing job grinds or rakes out the old mortar to a depth of at least twice the joint width — usually about 3/4 to 1 inch. Anything shallower doesn't give the new mortar enough surface to bond and it will pop out within a couple of freeze-thaw seasons."
  - q: "What's the difference between tuckpointing and repointing?"
    a: "Technically, repointing is grinding out failed mortar and packing in fresh mortar, while tuckpointing is a decorative technique using two mortar colors to create a crisp fine line. In everyday Chicago use the two words are treated as the same job — restoring the mortar joints between your bricks."
  - q: "Why is hard Type S mortar on old brick a red flag?"
    a: "Soft, historic Chicago brick needs a softer mortar (often Type N or a lime mix) that flexes and gives. When a contractor packs rigid Type S mortar into old brick, the mortar becomes harder than the brick, so freeze-thaw stress cracks and spalls the brick face instead of the sacrificial mortar. It's a common and costly mistake."
  - q: "Can I inspect a finished tuckpointing job myself?"
    a: "Yes. Stand back and check for uniform color and joint profile, then get close and run your finger along the joints for smeared mortar and hazing on the brick. Look for full, packed joints rather than a thin skim, and confirm any cracked or crumbling bricks were actually replaced."
  - q: "How long should good tuckpointing last?"
    a: "Quality tuckpointing with matched mortar, proper grinding depth, and clean tooled joints typically lasts 25 to 30 years or more in the Chicago climate. A cut-rate skim job can start failing in one to three winters, which is often the first sign something was done wrong."
  - q: "Should tuckpointing be done in cold weather?"
    a: "No. Mortar needs above-freezing temperatures to cure properly — generally 40 degrees and rising. Tuckpointing done in freezing Chicago weather won't set correctly, leading to weak, crumbling joints. A contractor pushing to point your walls in December is a red flag."
  - q: "What should I do if I already got a bad tuckpointing job?"
...
| What to check | Good tuckpointing | Bad tuckpointing |
|---|---|---|
| Grinding depth | Raked 3/4"–1" deep | Little or no grinding; skim over old |
| Joint fill | Packed full in lifts | Thin, hollow, or feathered |
| Mortar color | Matched to original | Stark, mismatched gray |
| Joint profile | Tooled to match wall | Flat, globbed, inconsistent |
| Brick faces | Clean, no haze | Smeared, hazy, "bag-rubbed" |
| Brick repair | Failed brick replaced | Pointed around cracks |
| Mortar type | Matched to brick hardness | One-size-fits-all, often too hard |
| Weather | Above 40°F, curing | Done in the cold |
| Lifespan | 25–30+ years | Fails in 1–3 winters |
...
- [Tuckpointing](/services/tuckpointing) — full grind-and-repoint, color and profile matched
- [Brick repair](/services/brick-repair) — replacing cracked and spalled brick the right way
- [Masonry sealing](/services/masonry-sealing) — breathable water protection for sound masonry
