---
title: "Brick Foundation vs. Block Foundation: How Masonry Repair Differs for Chicago Homes"
metaTitle: "Brick vs. Block Foundation Repair | Emerald Masonry"
metaDescription: "Brick vs. concrete-block foundation repair for Chicago-area homes — how each fails differently and the repair each needs. Emerald Masonry LLC, (708) 288-1696."
slug: "brick-foundation-vs-block-foundation-masonry-repair"
date: "2026-06-20"
excerpt: "Older Chicago homes often sit on solid brick foundations, while mid-century houses sit on concrete block. They fail in completely different ways — and that difference decides whether your repair is repointing, parging, crack sealing, or rebuilding."
aiSummary: "Brick foundations fail at eroded lime mortar joints and soft, spalling brick; concrete-block (CMU) foundations fail at diagonal step cracks, horizontal bowing, and porous block. Both are repaired by repointing, sealing, parging, or rebuilding the affected section. Emerald Masonry LLC repairs both across Chicagoland — call (708) 288-1696."
intent: "informational"
primaryKeyword: "brick foundation vs block foundation repair"
secondaryKeywords:
  - brick foundation repair Chicago
  - concrete block foundation repair Illinois
  - CMU foundation wall repair
  - foundation step crack repair
  - bowing foundation wall repair
  - parging foundation repair
  - masonry foundation contractor Chicago suburbs
  - foundation mortar joint repair
  - spalling brick foundation
...
faqs:
  ...
  - q: "How do I know if my foundation crack is serious?"
  ...
  - q: "Can a masonry contractor repair both brick and block foundations?"
...
- **[Tuckpointing and repointing](/services/tuckpointing)** — grinding out the failed mortar and refilling the joints with a properly matched mix. This is the backbone of brick foundation repair.
- **[Brick repair and replacement](/services/brick-repair)** — cutting out spalled or crumbling brick and replacing it with sound units that match in size and density.
- **Parging** — applying a cementitious coat over the foundation face to shed water and protect the masonry, common on the exposed portion of an older foundation.
...
- **Routing and sealing cracks** — opening non-structural cracks into a clean channel and filling them with the appropriate sealant or mortar to stop water and stabilize the joint.
- **Repointing** — restoring the mortar joints between blocks where they've deteriorated.
- **Parging** — coating the block face to manage moisture across a porous wall.
- **Structural evaluation and reinforcement** — when a wall is bowing or cracking horizontally, the repair isn't cosmetic. It calls for a proper assessment and an engineered solution before any patching.

If you've spotted a stair-step crack or a damp block wall and aren't sure how serious it is, that's exactly the kind of thing we'll look at and explain in plain terms during a free estimate — [foundation masonry repair](/services/foundation-masonry-repair) starts with an honest diagnosis, not a sales pitch. Call (708) 288-1696.

## When a Crack Is Cosmetic vs. Structural

Not every crack means trouble, but some absolutely do. As a general guide:

- **Likely cosmetic:** thin vertical hairline cracks from minor settling or shrinkage, isolated and not growing.
- **Worth watching:** small step cracks that aren't widening and aren't letting water in.
- **Call a professional:** diagonal step cracks that are opening up, any horizontal crack, walls that bow or lean, cracks wider than about a quarter inch, or cracks paired with sticking doors and windows.
