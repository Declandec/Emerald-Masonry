---
title: "Historic Masonry Preservation — What Makes It Different from Standard Repair"
date: "2026-04-24"
...
keywords:
  ...
  - preservation masonry contractor Chicagoland
  - historic building tuckpointing Illinois
  - lime mortar historic masonry Chicago
  - pre-war brick repair Chicago suburbs
  - historic masonry restoration Illinois
  - preservation mortar specification Illinois
  - Secretary of Interior Standards masonry
  - historic brick building repair Chicagoland
---
...
- Before roughly 1930: most commercial and institutional masonry used soft-fired clay brick (lower density, more porous, lower compressive strength) and lime-based mortar (soft, flexible, vapor-permeable, slow-setting)
- After 1930: Portland cement became the dominant binder, producing harder mortar; modern production brick is denser and harder than historic brick
- After World War II: the material transition is essentially complete for commercial construction; residential construction continued using some traditional materials into the 1950s
...
- Color matching (often complex — historic brick colors vary and may have weathered significantly from their original fired color)
- Texture matching (hand-molded vs. wire-cut vs. extruded surface texture)
- Size matching (historic brick dimensions often differ from modern standard sizes — particularly in length and thickness)
- Compressive strength matching (using modern hard brick to replace soft historic brick creates spot-hardness variations that concentrate stress)
