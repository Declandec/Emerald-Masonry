---
title: "Waterproofing After Tuckpointing: Sequence, Products, and What Actually Works"
date: "2026-04-02"
...
keywords:
  ...
  - brick waterproofing sequence
  - silane siloxane masonry sealer Chicago
  - commercial masonry waterproofing Chicagoland
  - tuckpointing and waterproofing sequence
  - masonry sealer vs tuckpointing
  - penetrating masonry sealer Illinois
  - brick sealer commercial building Chicago
  - waterproofing masonry repair Illinois
---
...
1. **Full condition assessment** — identify all pathways for water entry (joints, coping, flashing, caulk, cracks)
2. **Repair all deficiencies** — repoint joints, replace damaged brick, address coping and flashing, replace caulk
3. **Allow mortar to cure** — new mortar needs 28 days to reach design strength and stabilize; sealer applied too soon can affect the cure and clog pores before the mortar has properly set
4. **Clean the surface** — remove efflorescence, biological growth, and surface contamination that would prevent sealer penetration
5. **Apply sealer** — using the appropriate product for the masonry type and exposure
