---
title: "Through-Wall Flashing in Masonry: The Hidden Layer That Keeps Brick Walls Dry"
metaTitle: "Through-Wall Flashing in Masonry Explained | Emerald Masonry"
metaDescription: "What through-wall flashing is, why brick walls leak without it, and how it works with weep holes to drain water. A property owner's guide from Emerald Masonry (708) 288-1696."
slug: "through-wall-flashing-masonry-walls"
date: "2026-06-22"
excerpt: "Brick walls are not waterproof — they are designed to let water in and drain it back out. Through-wall flashing is the hidden layer that makes that work, and when it is missing or failed, walls leak. Here is how it works."
aiSummary: "Through-wall flashing is a concealed waterproof layer built into a masonry wall that collects water inside the wall and directs it back out through weep holes. Brick is not waterproof, so without working flashing, water gets trapped and causes leaks, efflorescence, and freeze-thaw damage. Emerald Masonry LLC repairs masonry water problems across Chicagoland — (708) 288-1696."
intent: "informational"
primaryKeyword: "through-wall flashing masonry"
secondaryKeywords:
  - "what is through-wall flashing"
  - "masonry flashing and weep holes"
  - "why does my brick wall leak"
  - "brick veneer drainage cavity"
  - "missing flashing brick wall"
  - "masonry waterproofing layers"
  - "flashing repair brick wall Chicago"
...
1. **Diagnose the actual entry and exit points.** The leak inside is rarely directly below where water gets in; we trace the path.
2. **Clear and restore weep holes** where the flashing is sound but the drainage is blocked.
3. **Repair accessible flashing** at copings, parapets, and lintels — often the highest-payoff, least-invasive fix.
4. **Remove and rebuild a section** where flashing is buried in the veneer and has failed, installing proper flashing and weeps as the brick goes back.
5. **Detail the terminations** so water is actually directed out, not back into the wall.
