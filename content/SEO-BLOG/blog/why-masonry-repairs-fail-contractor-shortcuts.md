---
title: "Why Masonry Repairs Fail: 6 Contractor Shortcuts That Ruin the Job"
date: "2026-07-04"
excerpt: "Most premature masonry failures aren't caused by old brick — they're caused by the shortcuts the wrong contractor takes. Here are the six mistakes that guarantee a repeat repair, how the job should actually be done, and how to spot the shortcut before you pay for it."
...
keywords:
  ...
  - "masonry repair shortcuts"
  - "bad tuckpointing signs"
  - "mismatched mortar repair"
  - "how to spot bad masonry work"
  - "premature masonry failure Chicago"
  - "freeze thaw brick damage"
  - "how to vet a masonry contractor"
  - "repointing vs skim coating"
  - "wrong mortar mix brick"
  - "masonry repair Chicagoland"
  - "tuckpointing failure"
  - "brick sealing mistakes"
  - "licensed masonry contractor Chicago"
  - "why does tuckpointing crack"
  - "masonry contractor red flags"
intent: "commercial"
aiSummary: "Masonry repairs fail prematurely because the wrong contractor takes shortcuts: mismatched mortar, joints ground too shallow, smearing over failed joints, sealing trapped moisture, mismatched replacement brick, and skipping the water-source fix. Emerald Masonry LLC does it the durable way — call (708) 288-1696 for a free on-site estimate."
faqs:
  - q: "Why did my tuckpointing crack or fall out within a year or two?"
    a: "Usually the joints were ground too shallow so the new mortar had nothing to grip, or a too-hard Portland mortar was used on soft brick. In Chicago's freeze-thaw cycles, that weak bond fails fast. Proper repointing rakes joints to the correct depth and matches mortar strength to the brick."
  - q: "How can I tell if a masonry contractor used the wrong mortar?"
    a: "Look for new joints that are a noticeably different color or that sit harder and shinier than the brick around them. Hairline cracks along the edge of the joint or spalling brick faces within a year are also warning signs. Correct mortar is color-matched and softer than the surrounding masonry."
  - q: "Is sealing my brick a good way to stop water damage?"
    a: "Only after the underlying cracks and failed joints are repaired. Sealing over trapped moisture or unrepaired cracks locks water inside the wall, and freeze-thaw expansion then pushes the brick face off. Repair first, dry out, then seal with a breathable product."
  - q: "Why does my masonry keep failing in the same spot after repairs?"
    a: "A recurring failure almost always means the water source was never fixed — bad flashing, a missing chimney cap, or grading that pushes water toward the wall. If the leak isn't stopped, any repair is temporary. The right approach fixes the source, then the masonry."
  - q: "How do I vet a masonry contractor before hiring?"
    a: "Confirm they are licensed, bonded, and insured, ask for local references and recent photos, and require a written scope that names mortar type, joint depth, and any water-source repairs. Emerald Masonry LLC provides all of this with a free on-site estimate at (708) 288-1696."
---
...
**The right way:** Match mortar strength to the brick and match the mortar color and joint profile to the existing wall. On older or historic masonry that often means a lime-rich, lower-strength mix. Our [tuckpointing & repointing](/services/tuckpointing) work always specifies the mortar type to the age and hardness of your brick.
...
**The right way:** Repair all cracks and failed joints, let the masonry dry, then apply a **breathable** water-repellent that lets vapor escape while blocking liquid water. Sequence matters as much as the product. See how we approach [masonry sealing / waterproofing](/services/masonry-sealing) as the last step, not the first.
...
**The right way:** Source replacement [brick repair](/services/brick-repair) units that match the original in size, color, and absorption, and reuse sound salvaged brick only where it genuinely matches. On historic buildings, matching the brick is as important as matching the mortar.
...
If your masonry has already been "fixed" once and is failing again — or you want it done right the first time — talk to a crew that does the raking, the matching, and the water-source work the shortcut artists skip. **[Request your free on-site estimate](/#contact) or call (708) 288-1696** and we'll walk your property, show you what's really happening in the wall, and give you a written scope you can hold us to.
